...
namespace CarePoint.Infrastructure.Data.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClinicDoctors_DoctorProfiles_DoctorProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_PatientProfileId_AppointmentDate",
                table: "Appointments",
                columns: new[] { "PatientProfileId", "AppointmentDate" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClinicDoctors_ClinicId_DoctorProfileId",
                table: "ClinicDoctors",
                columns: new[] { "ClinicId", "DoctorProfileId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ClinicDoctors_DoctorProfileId",
                table: "ClinicDoctors",
                column: "DoctorProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_DoctorAvailabilities_DoctorProfileId_DayOfWeek_StartTime",
                table: "DoctorAvailabilities",
                columns: new[] { "DoctorProfileId", "DayOfWeek", "StartTime" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorSpecialties_DoctorProfileId_SpecialtyId",
                table: "DoctorSpecialties",
                columns: new[] { "DoctorProfileId", "SpecialtyId" },
                unique: true);
