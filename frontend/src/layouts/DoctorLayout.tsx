...
import { DashboardIcon, CalendarIcon, DoctorIcon, LogoutIcon } from '../components/common/Icons';
      ...
      <aside style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 8px', marginBottom: 36 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <div style={{
              ...
              <DoctorIcon size={20} color="white" />
            </div>
        ...
        <div style={{ borderTop: '1px solid var(--border-default)', paddingTop: 16 }}>
          <div style={{ padding: '8px 12px', marginBottom: 8 }}>
            ...
            <div className="badge badge-amber" style={{ marginTop: 4 }}>Doctor</div>
          </div>
          <button
